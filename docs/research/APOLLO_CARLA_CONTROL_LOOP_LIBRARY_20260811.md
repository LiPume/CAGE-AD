...
## v4 补充的启动与换图资料（2026-08-11）

本轮新增文件位于 `web/v4_primary/`：

- `carla_0.9.15_first_steps.html`：CARLA 0.9.15 官方入门页，说明服务器默认通常加载 Town10，并可由客户端切换地图；
- `unreal_4.27_command_line_arguments.html`：与 CARLA 0.9.15 所用 Unreal 4 相同主版本的官方命令行说明；
- `carla_issue_2789_map_reload_hang.html`：CARLA 官方仓库中关于同步模式和重复重载世界发生挂起/连接失败的原始问题记录。

校验和：

- CARLA 0.9.15 入门页：`566580ff6460bb339be96c00914c3139d0ab77684968a69add9b8d65cb652a75`
- Unreal 4.27 命令行说明：`680478ebf61bd338bd9eec910a1997039dcec2310dd32a4c160564e26aeeafad`
